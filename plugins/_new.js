let {
 ...
 smd(
  {
    pattern: "channel",
    desc: "To get channel link",
    react: "🗨️",
    category: "user",
    filename: __filename,
  },
  async (message) => {
    const channelMessage = `BYTE-MD official WhatsApp Channel\n *Channel name:* _TalkDrove_ \n *Channel Owner:* _Hamza_ \n *Channel link:* https://whatsapp.com/channel/0029VaNRcHSJP2199iMQ4W0l`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*BYTE-MD CURRENTLY ACTIVE!*";
 ...
 smd({
   ...
   try {
     ...
     try {
       let {
         key: _0x2d7cf6
       } = await _0x4e7c63.send("Counting... 0", {}, "Hamza", _0x4e7c63);
 ...
 smd({
   ...
   try {
     if (!_0x23f786) {
       return await _0xe6d6e.reply("Hey there, do you want to talk?");
     }
     const _0x55bb61 = {
       method: "POST",
       headers: {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/HyHamza/BYTE-MD*");
     }
